...
/*
    ...
    If we run the application we would see a warning regarding componentWillMount because it will be
    removed eventually but in older versions of React, you can still use it.
*/
